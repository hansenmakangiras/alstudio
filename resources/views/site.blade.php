...
<head>
    ...
    <title>{{ config('adminlte.title') }} - Design Studio</title>
    <meta name="description" content="A free HTML5/CSS3 template made exclusively for Codrops"/>
    <meta name="keywords" content="html5 template, css3, one page, animations, agency, portfolio, web design"/>
    <meta name="author" content=""/>
    <!-- Bootstrap -->
    <script src="{{ asset('assets/frontpage/js/modernizr.custom.js') }}"></script>
    <link href="{{ asset('assets/frontpage/css/bootstrap.min.css') }}" rel="stylesheet">
    <link href="{{ asset('assets/frontpage/css/jquery.fancybox.css') }}" rel="stylesheet">
    <link href="{{ asset('assets/frontpage/css/flickity.css') }}" rel="stylesheet">
    <link href="{{ asset('assets/frontpage/css/animate.css') }}" rel="stylesheet">
    <link href="http://maxcdn.bootstrapcdn.com/font-awesome/4.2.0/css/font-awesome.min.css" rel="stylesheet">
    <link href='http://fonts.googleapis.com/css?family=Nunito:400,300,700' rel='stylesheet' type='text/css'>
    <link href="{{ asset('assets/frontpage/css/styles.css') }}" rel="stylesheet">
    <link href="{{ asset('assets/frontpage/css/queries.css') }}" rel="stylesheet">
        ...
        <div class="container">
            <div class="row nav-wrapper">
                <div class="col-md-6 col-sm-6 col-xs-6 text-left">
                    <a href="#"><img src="{{ asset('assets/frontpage/img/logo-white.png') }}" alt="Boxify Logo"></a>
                </div>
            ...
            <div class="col-md-6 nopadding features-intro-img">
                <div class="features-bg">
                    ...
                    <div class="features-img wp1">
                        <img src="{{ asset('assets/frontpage/img/html5-logo.png') }}" alt="HTML5 Logo">
                    </div>
                </div>
            </div>
                        ...
                        <div class="device-content">
                            <div class="showcase-slider">
                                <ul class="slides" id="showcaseSlider">
                                    ...
                                    <li>
                                        <img src="{{ asset('assets/frontpage/img/screen2.jpg') }}" alt="Device Content Image">
                                    </li>
                                    <li>
    ...
    <div class="container-fluid">
        <div class="row">
            <ul class="grid">
                <li>
                    <figure>
                        <img src="{{ asset('assets/frontpage/img/01-screenshot.jpg') }}" alt="Screenshot 01">
                        <figcaption>
                            <div class="caption-content">
                                <a href="{{ asset('assets/frontpage/img/large/01.jpg') }}" class="single_image">
                ...
                <li>
                    <figure>
                        <img src="{{ asset('assets/frontpage/img/02-screenshot.jpg') }}" alt="Screenshot 01">
                        <figcaption>
                            <div class="caption-content">
                                <a href="{{ asset('assets/frontpage/img/large/02.jpg') }}" class="single_image">
                                    <i class="fa fa-search"></i><br>
                ...
                <li>
                    <figure>
                        <img src="{{ asset('assets/frontpage/img/03-screenshot.jpg') }}" alt="Screenshot 01">
                        <figcaption>
                            <div class="caption-content">
                                <a href="{{ asset('assets/frontpage/img/large/03.jpg') }}" class="single_image">
                                    <i class="fa fa-search"></i><br>
                ...
                <li>
                    <figure>
                        <img src="{{ asset('assets/frontpage/img/04-screenshot.jpg') }}" alt="Screenshot 01">
                        <figcaption>
                            <div class="caption-content">
                                <a href="{{ asset('assets/frontpage/img/large/04.jpg') }}" class="single_image">
                                    <i class="fa fa-search"></i><br>
                                    <p>Absolutely Free</p>
                                </a>
                            </div>
        ...
        <div class="row">
            <ul class="grid">
                <li>
                    <figure>
                        <img src="{{ asset('assets/frontpage/img/05-screenshot.jpg') }}" alt="Screenshot 01">
                        <figcaption>
                            <div class="caption-content">
                                <a href="{{ asset('assets/frontpage/img/large/05.jpg') }}" class="single_image">
                                    <i class="fa fa-search"></i><br>
                ...
                <li>
                    <figure>
                        <img src="{{ asset('assets/frontpage/img/06-screenshot.jpg') }}" alt="Screenshot 01">
                        <figcaption>
                            <div class="caption-content">
                                <a href="{{ asset('assets/frontpage/img/large/06.jpg') }}" class="single_image">
                                    <i class="fa fa-search"></i><br>
                ...
                <li>
                    <figure>
                        <img src="{{ asset('assets/frontpage/img/07-screenshot.jpg') }}" alt="Screenshot 01">
                        <figcaption>
                            <div class="caption-content">
                                <a href="{{ asset('assets/frontpage/img/large/07.jpg') }}" class="single_image">
                                    <i class="fa fa-search"></i><br>
                                    <p>Made with Love</p>
                                </a>
                            </div>
                ...
                <li>
                    <figure>
                        <img src="{{ asset('assets/frontpage/img/08-screenshot.jpg') }}" alt="Screenshot 01">
                        <figcaption>
                            <div class="caption-content">
                                <a href="{{ asset('assets/frontpage/img/large/08.jpg') }}" class="single_image">
                                    <i class="fa fa-search"></i><br>
        ...
        <div class="row">
            <div class="col-md-5">
                <h1 class="footer-logo">
                    <img src="{{ asset('assets/frontpage/img/logo-blue.png') }}" alt="Footer Logo Blue">
                </h1>
...
<script src="{{ asset('assets/frontpage/js/min/toucheffects-min.js') }}"></script>
<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.0/jquery.min.js"></script>
<script src="{{ asset('assets/frontpage/js/flickity.pkgd.min.js') }}"></script>
<script src="{{ asset('assets/frontpage/js/jquery.fancybox.pack.js') }}"></script>
<!-- Include all compiled plugins (below), or include individual files as needed -->
<script src="{{ asset('assets/frontpage/js/retina.js') }}"></script>
<script src="{{ asset('assets/frontpage/js/waypoints.min.js') }}"></script>
<script src="{{ asset('assets/frontpage/js/bootstrap.min.js') }}"></script>
<script src="{{ asset('assets/frontpage/js/min/scripts-min.js') }}"></script>
